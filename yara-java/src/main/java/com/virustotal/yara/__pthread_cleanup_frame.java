 ...
 * void (*__cancel_routine)(void*);
    ...
    public interface __cancel_routine {
        ...
        static MemorySegment allocate(__cancel_routine fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(__cancel_routine.class, fi, __pthread_cleanup_frame.__cancel_routine$FUNC, scope);
        }
        static __cancel_routine ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return (java.lang.foreign.MemorySegment __x0) -> {
                try {
                    __pthread_cleanup_frame.__cancel_routine$MH.invokeExact(symbol, __x0);
                } catch (Throwable ex$) {
