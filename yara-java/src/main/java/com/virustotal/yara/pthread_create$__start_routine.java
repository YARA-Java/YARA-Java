...
public interface pthread_create$__start_routine {
    ...
    static MemorySegment allocate(pthread_create$__start_routine fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(pthread_create$__start_routine.class, fi, constants$68.pthread_create$__start_routine$FUNC, scope);
    }
    static pthread_create$__start_routine ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _self) -> {
            try {
                return (java.lang.foreign.MemorySegment)constants$68.pthread_create$__start_routine$MH.invokeExact(symbol, _self);
            } catch (Throwable ex$) {
